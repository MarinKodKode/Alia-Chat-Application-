...
import com.mahm.chatkode.adapters.RecentConversationAdapter;
import com.mahm.chatkode.databinding.ActivityMainBinding;
import com.mahm.chatkode.listeners.ConversionListener;
import com.mahm.chatkode.models.ChatMessage;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void loadUserDetails(){
        ...
        binding.imageProfiles.setImageBitmap(bitmap);
    }
    ...
    private void updateToken(String token){
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN,token)
                .addOnFailureListener(e -> showToast("No se pudo actualizar el token"));
    }
    ...
    private void signOut(){
        ...
        documentReference.update(updates)
                ...
                .addOnFailureListener(e -> showToast("No se pudo cerrar la sesión"));
    }
