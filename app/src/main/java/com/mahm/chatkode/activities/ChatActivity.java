...
import com.mahm.chatkode.adapters.ChatAdapter;
import com.mahm.chatkode.databinding.ActivityChatBinding;
import com.mahm.chatkode.models.ChatMessage;
import com.mahm.chatkode.models.User;
import com.mahm.chatkode.network.ApiClient;
import com.mahm.chatkode.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    /*Create the complete message and prepare it for send it*/
    private void sendMessage() {
        ...
        if (textMessage.isEmpty()) {
            ...
            if (conversionId != null) {
                ...
                conversion.put(Constants.SENDER_IMAGE, preferenceManager.getString(Constants.KEY_IMAGE));
